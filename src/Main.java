...
public class Main {
    public static void main(String[] args) {
        ...
        File fileStud = new File("D:\\Enrico Nepa\\Scuola\\Epicode\\Back-End\\Lezioni\\Settimana3\\BE-ProgettoSettimana3\\Scuola\\Studenti.txt");
        ...
        //STUDENTI
        Studente mario = new Studente(1,"Mario","Rossi",'M');
        Studente luigi = new Studente(2,"Luigi","Verdi",'M');
        Studente rosa = new Studente(3,"Rosa","Viola",'F');
        Studente michela = new Studente(4,"Michela","Gialli",'F');
        Studente maria = new Studente(5,"Maria","Neri",'F');
        ...
        //STUDENTI
        Studente luca = new Studente(1,"Luca","Arancioni",'M');
        Studente gianni = new Studente(2,"Gianni","Bianchi",'M');
        Studente marina = new Studente(3,"Marina","Rosi",'F');
        Studente chiara = new Studente(4,"Chiara","Lime",'F');
        Studente matteo = new Studente(5,"Matteo","Azzurri",'M');
